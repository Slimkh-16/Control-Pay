...
function updateParallax() {
    ...
    $(".parallax").each(function(a, l) {
        objOffset = $(l).offset(),
        parallaxScale = .8,
        parallaxOpacity = 0,
        parallaxOffset = -100,
        scrollOffset > objOffset.top && (scrollValue = (scrollOffset - objOffset.top) / $(window).height() * 2,
        scrollValue = scrollValue > 1 ? 1 : scrollValue,
        parallaxScale += .2 * scrollValue,
        parallaxOpacity += 1 * scrollValue,
        parallaxOffset += parseInt(100 * scrollValue)),
        $(l).hasClass("-pop") && $(l).css({
    ...
    $(".parallax-inverted").each(function(a, l) {
        objOffset = $(l).offset(),
        parallaxOpacity = 1,
        parallaxOffset = 0,
        scrollOffset > objOffset.top && (scrollValue = (scrollOffset - objOffset.top) / $(window).height() * 2,
