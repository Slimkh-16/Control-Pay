...
function updateParallax(){scrollOffset=$(window).scrollTop()+$(window).height()/4*5,$(".parallax").each(function(a,t){objOffset=$(t).offset(),parallaxScale=.8,parallaxOpacity=0,parallaxOffset=-100,scrollOffset>objOffset.top&&(scrollValue=(scrollOffset-objOffset.top)/$(window).height()*2,scrollValue=scrollValue>1?1:scrollValue,parallaxScale+=.2*scrollValue,parallaxOpacity+=1*scrollValue,parallaxOffset+=parseInt(100*scrollValue)),$(t).hasClass("-pop")&&$(t).css({filter:"opacity("+parallaxOpacity+")",transform:"scale("+parallaxScale+")",transition:"all 500ms ease-out"}),$(t).hasClass("-slide-top")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( 0px, "+-1*parallaxOffset+"px, 0px )",transition:"all 1000ms ease-out"}),$(t).hasClass("-slide-bottom")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( 0px, "+1*parallaxOffset+"px, 0px )",transition:"all 1000ms ease-out"}),$(t).hasClass("-slide-left")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( "+-1*parallaxOffset+"px, 0px, 0px )",transition:"all 1000ms ease-out"}),$(t).hasClass("-slide-right")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( "+1*parallaxOffset+"px, 0px, 0px )",transition:"all 1000ms ease-out"})}),scrollOffset=$(window).scrollTop(),$(".parallax-inverted").each(function(a,t){objOffset=$(t).offset(),parallaxOpacity=1,parallaxOffset=0,scrollOffset>objOffset.top&&(scrollValue=(scrollOffset-objOffset.top)/$(window).height()*2,scrollValue=scrollValue<0?0:scrollValue,scrollValue=scrollValue>1?1:scrollValue,parallaxOpacity-=1*scrollValue,parallaxOffset+=parseInt(150*scrollValue)),$(t).hasClass("-slide-top")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( 0px, "+-1*parallaxOffset+"px, 0px )",transition:"all 1000ms ease-out"}),$(t).hasClass("-slide-bottom")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( 0px, "+1*parallaxOffset+"px, 0px )",transition:"all 1000ms ease-out"}),$(t).hasClass("-slide-left")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( "+-1*parallaxOffset+"px, 0px, 0px )",transition:"all 1000ms ease-out"}),$(t).hasClass("-slide-right")&&$(t).css({webkitFilter:"opacity("+parallaxOpacity+")",transform:"translate3d( "+1*parallaxOffset+"px, 0px, 0px )",transition:"all 1000ms ease-out"})})}$(document).ready(function(){new ScrollFlow}),$.fn.ScrollFlow=function(a){new ScrollFlow(a)},ScrollFlow=function(a){this.init(a)},$.extend(ScrollFlow.prototype,{init:function(a){this.options=$.extend({useMobileTimeouts:!0,mobileTimeout:100,durationOnLoad:0,durationOnResize:250,durationOnScroll:500},a),this.lastScrollTop=0,this.bindScroll(),this.bindResize(),this.update(this.options.durationOnLoad)},bindScroll:function(){var a=this;$(window).scroll(function(){a.update()}),$(window).bind("gesturechange",function(){a.update()})},bindResize:function(){var a=this;$(window).resize(function(){a.update(a.options.durationOnResize)})},update:function(a){var t=this;winHeight=$(window).height(),scrollTop=$(window).scrollTop(),$(".scrollflow").each(function(s,l){objOffset=$(l).offset(),objOffsetTop=parseInt(objOffset.top),effectDuration=t.options.durationOnScroll,effectDuration="undefined"!=typeof a?a:effectDuration,effectiveFromPercentage=isNaN(parseInt($(l).attr("data-scrollflow-start")/100))?-.25:parseInt($(l).attr("data-scrollflow-start"))/100,scrollDistancePercentage=isNaN(parseInt($(l).attr("data-scrollflow-distance")/100))?.5:parseInt($(l).attr("data-scrollflow-distance"))/100,effectiveFrom=objOffsetTop-winHeight*(1-effectiveFromPercentage),effectiveTo=objOffsetTop-winHeight*(1-scrollDistancePercentage),parallaxScale=.8,parallaxOpacity=0,parallaxOffset=-100,factor=0,scrollTop>effectiveFrom&&(factor=(scrollTop-effectiveFrom)/(effectiveTo-effectiveFrom),factor=factor>1?1:factor),options={opacity:1,scale:1,translateX:0,translateY:0},$(l).hasClass("-opacity")&&(options.opacity=0+factor),$(l).hasClass("-pop")&&(options.scale=.8+.2*factor),$(l).hasClass("-slide-left")&&(options.translateX=-1*(-100+100*factor)),$(l).hasClass("-slide-right")&&(options.translateX=-100+100*factor),$(l).hasClass("-slide-top")&&(options.translateY=-1*(-100+100*factor)),$(l).hasClass("-slide-bottom")&&(options.translateY=-100+100*factor),$(l).css({webkitFilter:"opacity("+options.opacity+")",mozFilter:"opacity("+options.opacity+")",oFilter:"opacity("+options.opacity+")",msFilter:"opacity("+options.opacity+")",filter:"opacity("+options.opacity+")",webkitTransform:"translate3d( "+parseInt(options.translateX)+"px, "+parseInt(options.translateY)+"px, 0px ) scale("+options.scale+")",mozTransform:"translate3d( "+parseInt(options.translateX)+"px, "+parseInt(options.translateY)+"px, 0px ) scale("+options.scale+")",oTransform:"translate3d( "+parseInt(options.translateX)+"px, "+parseInt(options.translateY)+"px, 0px ) scale("+options.scale+")",msTransform:"translate3d( "+parseInt(options.translateX)+"px, "+parseInt(options.translateY)+"px, 0px ) scale("+options.scale+")",transform:"translate3d( "+parseInt(options.translateX)+"px, "+parseInt(options.translateY)+"px, 0px ) scale("+options.scale+")",transition:"all "+effectDuration+"ms ease-out"})})}}),$(document).ready(function(){updateParallax(),$(window).scroll(function(){updateParallax()}),$(window).resize(function(){updateParallax()})});
